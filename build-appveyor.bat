...
SET PATH=C:/projects/libosmium/expat.v140.2.2.5/build/native/bin/x64/%config%;%PATH%
...
SET PATH=C:/projects/libosmium/bzip2.v140.1.0.6.9/build/native/bin/x64/%config%;%PATH%
...
-DZLIB_INCLUDE_DIR=C:/projects/libosmium/zlib-vc140-static-64.1.2.11/lib/native/include ^
-DZLIB_LIBRARY=C:/projects/libosmium/zlib-vc140-static-64.1.2.11/lib/native/libs/x64/static/%config%/zlibstatic.lib ^
-DEXPAT_INCLUDE_DIR=C:/projects/libosmium/expat.v140.2.2.5/build/native/include ^
-DEXPAT_LIBRARY=C:/projects/libosmium/expat.v140.2.2.5/build/native/lib/x64/%config%/libexpat%libpostfix%.lib ^
-DBZIP2_INCLUDE_DIR=C:/projects/libosmium/bzip2.v140.1.0.6.9/build/native/include ^
-DBZIP2_LIBRARIES=C:/projects/libosmium/bzip2.v140.1.0.6.9/build/native/lib/x64/%config%/libbz2%libpostfix%.lib
