...
namespace osmium {
    ...
    namespace index {
        ...
        namespace map {
            ...
            using DenseMapMmap = VectorBasedDenseMap<osmium::detail::mmap_vector_anon<TValue>, TKey, TValue>;

            template <typename TKey, typename TValue>
            using SparseMapMmap = VectorBasedSparseMap<TKey, TValue, osmium::detail::mmap_vector_anon>;
