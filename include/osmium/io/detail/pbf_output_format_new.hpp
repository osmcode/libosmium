#ifndef OSMIUM_IO_DETAIL_PBF_OUTPUT_FORMAT_NEW_HPP
#define OSMIUM_IO_DETAIL_PBF_OUTPUT_FORMAT_NEW_HPP
...
namespace osmium {
    ...
    namespace io {
        ...
        namespace detail {
            ...
            class PBFOutputFormatNew : public osmium::io::detail::OutputFormat, public osmium::handler::Handler {
                ...
                PBFOutputFormatNew(const PBFOutputFormatNew&) = delete;
                PBFOutputFormatNew& operator=(const PBFOutputFormatNew&) = delete;

            public:

                explicit PBFOutputFormatNew(const osmium::io::File& file, data_queue_type& output_queue) :
            ...
            namespace {
                ...
                const bool registered_pbf_output = osmium::io::detail::OutputFormatFactory::instance().register_output_format(osmium::io::file_format::pbf,
                    [](const osmium::io::File& file, data_queue_type& output_queue) {
                        return new osmium::io::detail::PBFOutputFormatNew(file, output_queue);
                });
...
#endif // OSMIUM_IO_DETAIL_PBF_OUTPUT_FORMAT_NEW_HPP
