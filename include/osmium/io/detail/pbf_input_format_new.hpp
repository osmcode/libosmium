#ifndef OSMIUM_IO_DETAIL_PBF_INPUT_FORMAT_NEW_HPP
#define OSMIUM_IO_DETAIL_PBF_INPUT_FORMAT_NEW_HPP
...
#include <osmium/io/detail/pbf_parser_new.hpp>
...
namespace osmium {
    ...
    namespace io {
        ...
        namespace detail {
             ...
             */
            class PBFInputFormatNew : public osmium::io::detail::InputFormat {
            ...
            public:
                 ...
                 */
                PBFInputFormatNew(const osmium::io::File& file, osmium::osm_entity_bits::type read_which_entities, osmium::thread::Queue<std::string>& input_queue) :
                    ...
                    if (m_read_which_entities != osmium::osm_entity_bits::nothing) {
                        m_reader = std::thread(&PBFInputFormatNew::parse_osm_data, this, m_read_which_entities);
                    }
                }
            ...
            namespace {
                ...
                const bool registered_pbf_input = osmium::io::detail::InputFormatFactory::instance().register_input_format(osmium::io::file_format::pbf,
                    [](const osmium::io::File& file, osmium::osm_entity_bits::type read_which_entities, osmium::thread::Queue<std::string>& input_queue) {
                        return new osmium::io::detail::PBFInputFormatNew(file, read_which_entities, input_queue);
                });
...
#endif // OSMIUM_IO_DETAIL_PBF_INPUT_FORMAT_NEW_HPP
