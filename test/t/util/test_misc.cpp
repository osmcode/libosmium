...
TEST_CASE("string to integer conversion") {
    ...
    test_conv<uint64_t>();
    REQUIRE(osmium::detail::str_to_int<uint64_t>("9223372036854775806") == 9223372036854775806);
