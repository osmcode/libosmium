...
describe('osmium', function() {
   ...
   it('should be able to read ISO time from node', function(done) {
    ...
    it('should be able to use location handler', function(done) {
        ...
        handler.on('way', function(way) {
            if (ways == 0) {
                assert.equal(way.wkt(), "LINESTRING(-120.187277 48.47159,-120.188291 48.472511,-120.188374 48.472591,-120.188496 48.472707,-120.188625 48.47283,-120.18914 48.473561)");
            }
            ++ways;
        });
        handler.on('done', function() {
